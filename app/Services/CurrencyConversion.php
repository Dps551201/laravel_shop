...
class CurrencyConversion
{
    ...
    public static function convert($amount, $originCurrencyCode = self::DEFAULT_CURRENCY_CODE, $targetCurrencyCode = null)
    {
        self::loadContainer();
        ...
        return $amount / $originCurrency->rate * $targetCurrency->rate;
    }
